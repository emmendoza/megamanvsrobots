...
void glDrawSpriteL(GLuint tex, int x, int y, int w, int h) { glDrawSprite(tex, (x + w), y, (-w), h); }
void glDrawSpriteR(GLuint tex, int x, int y, int w, int h) { glDrawSprite(tex, x, y, w, h); }